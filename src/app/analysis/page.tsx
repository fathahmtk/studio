                      ...
                      <Card key={recipe.id} className="w-full">
                          ...
                          <CardContent className="text-sm space-y-2">
                               <div className="flex justify-between">
                                  ...
                                  <span>QAR {ingredientCost.toFixed(2)}</span>
                              </div>
                               <div className="flex justify-between">
                                  <span className="text-muted-foreground">Labor/Overhead</span>
                                  <span>QAR {otherCosts.toFixed(2)}</span>
                              </div>
                              <div className="flex justify-between font-semibold">
                               ...
                               <div className="flex justify-between font-bold text-primary">
                                  ...
                                  <span>QAR {suggestedPrice.toFixed(2)}</span>
                              </div>
                    ...
                    <CardContent className="text-sm space-y-2">
                      {portionSizes.map(size => (
                        <div key={size.name} className="flex justify-between">
                          <span className="text-muted-foreground">{size.name} Cost</span>
                          <span className="font-semibold">QAR {(baseCost * size.multiplier).toFixed(2)}</span>
                        </div>
                      ))}
                    </CardContent>
                  </Card>
